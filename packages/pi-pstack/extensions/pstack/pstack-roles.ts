...
export type PstackRoleCardinality =
	(typeof ROLE_CARDINALITIES)[keyof typeof ROLE_CARDINALITIES];

/** One pstack role's cardinality, picker purpose, and v1 legacy name. */
